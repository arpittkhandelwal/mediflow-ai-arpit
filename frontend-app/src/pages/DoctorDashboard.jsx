        ...
        <div className="dashboard-header">
          <div>
            <h1 className="dashboard-title">
              {tab === "Overview"
                ? `Dr. ${profile?.name || user?.email} 👋`
                : tab}
            </h1>
            {tab === "Overview" && (
              <p className="dashboard-greeting">
                {profile?.doctor_details?.specialization || "General Physician"}{" "}
            ...
            <div className="card">
              ...
              >
                ...
                <button
                  ...
                  onClick={() => setTab("Write Prescription")}
                >
        ...
        {tab === "Patients" && (
          <div className="grid-3">
            {patients.map((p) => (
              ...
              >
                ...
                <button
                  ...
                  onClick={() =>
                    setRxForm((f) => ({ ...f, patient_id: p.id })) ||
                    setTab("Write Prescription")
                  }
                >
                  ✍️ Write Prescription
                </button>
            ...
            {!patients.length && (
              ...
              >
                No patients yet — appointments will list them here.
              </div>
            )}
          </div>
        )}
          ...
          <div className="card" style={{ maxWidth: 700 }}>
            ...
            <div className="form-group" style={{ marginBottom: "1rem" }}>
              ...
              <select
                ...
                onChange={(e) =>
                  setRxForm((p) => ({ ...p, patient_id: e.target.value }))
                }
              >
            ...
            <div className="form-group" style={{ marginBottom: "1.5rem" }}>
              ...
              <textarea
                className="textarea"
                placeholder="e.g. Take medicines after food. Follow up in 7 days."
                value={rxForm.notes}
                onChange={(e) =>
                  setRxForm((p) => ({ ...p, notes: e.target.value }))
                }
                rows={3}
              />
            </div>
