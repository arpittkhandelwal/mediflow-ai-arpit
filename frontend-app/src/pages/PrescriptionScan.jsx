      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "2rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <p style={{ color: "var(--on-surface-var)" }}>
            Upload a prescription image — AI extracts medicines and dosage
            automatically
          </p>
        </div>
        ...
        >
          ...
          {preview ? (
            ...
            <>
              ...
              <p
                style={{ fontSize: "0.85rem", color: "var(--on-surface-var)" }}
              >
        ...
        {file && (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div
                style={{ fontSize: "0.78rem", color: "var(--on-surface-var)" }}
              >
          ...
          <div className="ai-panel" style={{ marginTop: "2rem" }}>
            ...
            >
              ...
              <div>
                ...
                >
                  OCR Confidence: {result.ocr?.confidence || "N/A"}%
                </div>
              </div>
            </div>
            ...
            {result.parsed?.patient_name && (
              <div style={{ marginBottom: "1rem" }}>
                ...
                <div style={{ color: "var(--on-surface-var)" }}>
                  {result.parsed.patient_name}
                </div>
              </div>
            )}
            ...
            <div style={{ marginBottom: "1.25rem" }}>
              ...
              {result.parsed?.medicines?.length > 0 ? (
                ...
                >
                  No medicines detected. Please ensure the image is clear.
                </p>
              )}
            </div>
