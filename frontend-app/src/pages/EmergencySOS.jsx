    ...
    try {
      navigator.geolocation.getCurrentPosition(
        async (pos) => {
          ...
          try {
            const res = await emergencyAPI.sos({
              latitude,
              longitude,
              message,
            });
      ...
      toast.error("SOS activation failed");
      setActivating(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", maxWidth: 500 }}>
        ...
        >
          Tap the button below to immediately send your location to emergency
          services. Your doctor and emergency contacts will be notified.
        </p>
        ...
        >
          ...
          <textarea
            className="textarea"
            placeholder="e.g. Severe chest pain, unable to breathe..."
            rows={3}
            value={message}
        ...
        >
          ...
          <p style={{ fontSize: "0.85rem", color: "var(--on-surface-var)" }}>
            India Emergency:{" "}
            <a href="tel:112" style={{ color: "#dc2626", fontWeight: 700 }}>
              112
            </a>{" "}
            · Ambulance:{" "}
            <a href="tel:108" style={{ color: "#dc2626", fontWeight: 700 }}>
              108
            </a>
          </p>
        </div>
