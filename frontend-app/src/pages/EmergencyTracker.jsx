  ...
  return (
    ...
    >
      <div style={{ maxWidth: 500, width: "100%", textAlign: "center" }}>
        <div
          style={{
            fontSize: emergency?.status === "resolved" ? "5rem" : "4rem",
            marginBottom: "1rem",
        ...
        <h1
          style={{
            fontSize: "2rem",
            color:
              emergency?.status === "resolved" ? "var(--secondary)" : "#dc2626",
            marginBottom: "0.5rem",
          }}
        >
          {emergency?.status === "resolved"
        ...
        {emergency?.status !== "resolved" && (
          <>
            ...
            <p
              style={{ color: "var(--on-surface-var)", marginBottom: "1.5rem" }}
            >
        ...
        {emergency && (
          ...
          >
            ...
            >
              <span
                className={`badge ${emergency.status === "active" ? "badge-error" : "badge-success"}`}
              >
        ...
        >
          {emergency?.status === "active" && (
            <button
              className={`btn btn-primary ${resolving ? "btn-loading" : ""}`}
              onClick={resolve}
              disabled={resolving}
