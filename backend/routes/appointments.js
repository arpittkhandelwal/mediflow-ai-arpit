...
const { bookAppointmentValidator, validateRequest } = require('../middlewares/validation');

router.use(authenticate);
router.post('/book',       bookAppointmentValidator, validateRequest, bookAppointment);
