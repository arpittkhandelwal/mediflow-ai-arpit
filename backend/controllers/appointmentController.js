...
const bookAppointment = async (req, res) => {
  try {
    ...
    logger.info(`Appointment booked: patient=${patient.id}, doctor=${doctor_id}, date=${date}`);
...
module.exports = { bookAppointment, getAppointments, updateAppointmentStatus, getAvailableSlots };
